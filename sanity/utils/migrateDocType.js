...
// Run this script with: `sanity exec --with-user-token utils/migrateDocType.js`
//
...
const OLD_TYPE = "forSaleGrid";
const NEW_TYPE = "inventoryGrid";
...
const buildMutations = docs => {
  ...
  docs.forEach(doc => {
    console.log("forSaleCategoryGrid", doc._id);
