 ...
 * 5. Run `sanity exec utils/removeField.js --with-user-token` in your terminal to delete the field from all matched documents
 */
 ...
 const FIELD_TO_REMOVE = 'modelReference'
